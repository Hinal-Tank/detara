...
export const metadata: Metadata = {
  ...
  description:
    'The DETARA KISS Collection: a curated selection of certified diamond jewellery. Engagement rings, stud earrings, tennis bracelets and pendants. Natural and lab-grown diamonds.',
  keywords: [
    'KISS collection',
    'DETARA KISS',
...
export default function KissLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
